...
//http://localhost:1001/002_RESTfulEasy/rest/selam
...
public class Merkez {
	...
	//http://localhost:1001/002_RESTfulEasy/rest/selam/sorgu1
	@GET // Alma türü
	@Path(value = "/sorgu1")
	@Produces("text/html") // Çýktýsý yazý olacak
	...
	//http://localhost:1001/002_RESTfulEasy/rest/selam/sorgu2
	@GET // Alma türü
	@Path(value = "/sorgu2")
	@Produces("text/html") // Çýktýsý yazý olacak
	...
	//http://localhost:1001/002_RESTfulEasy/rest/selam/sorgu3/{parametre}
	@GET // Alma türü
	...
	//http://localhost:1001/002_RESTfulEasy/rest/selam/sorgu4?parametre=
	@GET // Alma türü
	@Path(value = "/sorgu4")
